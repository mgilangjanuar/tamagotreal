    ...
    <Layout.Content style={{ minHeight: '86vh', position: 'relative', padding: '30px 20px' }}>
      <Row gutter={16}>
        <Col lg={{ span: 16, offset: 4 }} md={{ span: 18, offset: 2 }} span={24}>
          ...
          <p>Your privacy is important to us. It is Tamagotreal&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://tamagotreal.vercel.app">https://tamagotreal.vercel.app</a>, and other sites we own and operate. </p>
